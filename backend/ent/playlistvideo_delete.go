...
func (pvd *PlaylistVideoDelete) Where(ps ...predicate.PlaylistVideo) *PlaylistVideoDelete {
...
// PlaylistVideoDeleteOne is the builder for deleting a single PlaylistVideo entity.
...
func (pvdo *PlaylistVideoDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{playlistvideo.Label}
	default:
		return nil
	}
}
