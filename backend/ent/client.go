...
import (
	...
	"github.com/pongsakorn-maker/entgo-playground/ent/migrate"
...
type Client struct {
	...
	// PlaylistVideo is the client for interacting with the PlaylistVideo builders.
	PlaylistVideo *PlaylistVideoClient
...
func (c *Client) init() {
	...
	c.PlaylistVideo = NewPlaylistVideoClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		PlaylistVideo: NewPlaylistVideoClient(cfg),
...
// PlaylistVideoClient is a client for the PlaylistVideo schema.
type PlaylistVideoClient struct {
	config
}

// NewPlaylistVideoClient returns a client for the PlaylistVideo from the given config.
func NewPlaylistVideoClient(c config) *PlaylistVideoClient {
	return &PlaylistVideoClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `playlistvideo.Hooks(f(g(h())))`.
func (c *PlaylistVideoClient) Use(hooks ...Hook) {
	c.hooks.PlaylistVideo = append(c.hooks.PlaylistVideo, hooks...)
}

// Create returns a create builder for PlaylistVideo.
func (c *PlaylistVideoClient) Create() *PlaylistVideoCreate {
...
// BulkCreate returns a builder for creating a bulk of PlaylistVideo entities.
func (c *PlaylistVideoClient) CreateBulk(builders ...*PlaylistVideoCreate) *PlaylistVideoCreateBulk {
	return &PlaylistVideoCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for PlaylistVideo.
func (c *PlaylistVideoClient) Update() *PlaylistVideoUpdate {
...
// UpdateOne returns an update builder for the given entity.
func (c *PlaylistVideoClient) UpdateOne(pv *PlaylistVideo) *PlaylistVideoUpdateOne {
	mutation := newPlaylistVideoMutation(c.config, OpUpdateOne, withPlaylistVideo(pv))
	return &PlaylistVideoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *PlaylistVideoClient) UpdateOneID(id int) *PlaylistVideoUpdateOne {
	mutation := newPlaylistVideoMutation(c.config, OpUpdateOne, withPlaylistVideoID(id))
	return &PlaylistVideoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for PlaylistVideo.
func (c *PlaylistVideoClient) Delete() *PlaylistVideoDelete {
...
// DeleteOne returns a delete builder for the given entity.
func (c *PlaylistVideoClient) DeleteOne(pv *PlaylistVideo) *PlaylistVideoDeleteOne {
	return c.DeleteOneID(pv.ID)
}

// DeleteOneID returns a delete builder for the given id.
func (c *PlaylistVideoClient) DeleteOneID(id int) *PlaylistVideoDeleteOne {
	builder := c.Delete().Where(playlistvideo.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PlaylistVideoDeleteOne{builder}
}

// Query returns a query builder for PlaylistVideo.
func (c *PlaylistVideoClient) Query() *PlaylistVideoQuery {
	return &PlaylistVideoQuery{config: c.config}
}

// Get returns a PlaylistVideo entity by its id.
func (c *PlaylistVideoClient) Get(ctx context.Context, id int) (*PlaylistVideo, error) {
	return c.Query().Where(playlistvideo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PlaylistVideoClient) GetX(ctx context.Context, id int) *PlaylistVideo {
	pv, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
