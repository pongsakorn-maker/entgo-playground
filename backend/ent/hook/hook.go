...
// The PlaylistVideoFunc type is an adapter to allow the use of ordinary
// function as PlaylistVideo mutator.
type PlaylistVideoFunc func(context.Context, *ent.PlaylistVideoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PlaylistVideoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
